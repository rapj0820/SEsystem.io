    ...
    <div class="container-fluid">
      <div class="row">
        <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
          ...
          <div class="position-sticky pt-3 sidebar-sticky">
            <ul class="nav flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link" href="myrequests.php">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
          ...
          <button class="btn btn-outline-primary btn-sm mt-2 mb-2 px-3" onclick="btn_add_lm()">Request Material</button>
        ...
        <form id="update_lerningM">
          ...
          <div class="modal-body">
            ...
            <div class="mb-3 row">
              <label for="username" class="col-sm-3 col-form-label">Property #</label>
              <div class="col-sm-5">
                <input type="text" class="form-control" id="update_propnum" name="propnum" disabled autocomplete="off" required>
              </div>
              <label for="username" class="col-2 col-form-label">Grade</label>
              <div class="col-2">
