...
if (isset($_POST['r'])) {
	...
	?>
        ...
        <thead>
            <tr>
                <th scope="col" colspan="5"><i class="text-warning bi-square-fill"> Pending</i> <i class="bi-arrow-right"></i> <i class="text-success bi-square-fill"> Approved</i> <i class="bi-arrow-right"></i> <i class="text-secondary bi-square-fill"> Outgoing</i> <i class="bi-arrow-right"></i> <i class="text-primary bi-square-fill"> Incomming</i> <i class="bi-arrow-right"></i> <i class="text-dark bi-square-fill"> Arrived</i> <i class="bi-arrow-right"> Distributed</i>  </th>
            ...
            <tr style = "text-align:center;">
                <th scope="col" style="text-align: center; width:80px;" class="bg-dark"><i class="bi bi-hourglass-split text-light"></i></th>
        ...
        ?>
            <tr>
                <?php 
                if($row['stat']=='Pending'){
                    echo "<td class='table-warning' style='text-align: center;'> Pending";
                } elseif($row['stat']=='Approved') {
                    echo "<td class='table-success' style='text-align: center;'> Approved";
                }elseif($row['stat']=='Outgoing') {
                    echo "<td class='table-secondary' style='text-align: center;'> Outgoing";
                }elseif($row['stat']=='Incoming') {
                    echo "<td class='table-primary' style='text-align: center;'> Incoming";
                }elseif($row['stat']=='Declined'){
                    echo "<td class='table-danger' style='text-align: center;'> Declined";
                }elseif($row['stat']=='Arrived'){
                    echo "<td class='table-light' style='text-align: center;'> Arrived";
                }
                ?>
