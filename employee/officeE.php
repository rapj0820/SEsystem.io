    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
          ...
          <button class="btn btn-outline-primary btn-sm mt-2 mb-2 px-3" onclick="btn_add_lm()">Request Office Equipment</button>
        ...
        <form id="update_lerningM">
          ...
          <div class="modal-body">
            ...
            <div class="mb-3 row">
              <label for="username" class="col-sm-3 col-form-label">Property #</label>
              <div class="col-sm-5">
                <input type="text" class="form-control" id="update_propnum" disabled name="propnum" autocomplete="off" required>
              </div>
              <label for="username" class="col-2 col-form-label">Grade</label>
              <div class="col-2">
