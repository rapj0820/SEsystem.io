...
<html lang="en">
  <head>
    ...
    <title>Inventory System - Teaching Materials</title>
      ...
      <div class="row">
        <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
          ...
          <div class="position-sticky pt-3 sidebar-sticky">
            <ul class="nav flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link active ms-2" href="teachingM.php">
                  <i class="bi-pen"></i>
                  Teaching Materials
                </a>
              </li>
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2"><i class="bi-pen"></i> Teaching Materials</h1>
            <input type="hidden" class="form-control w-25" id="searchprp" placeholder="Search Property #">
            <input type="hidden" name="" id="invtype" value="Teaching Material">
          ...
          <button class="btn btn-outline-primary btn-sm mt-2 mb-2 px-3" onclick="btn_add_lm()">Add Teaching Materials</button>
          <a href="pdfReport/report.php?lm=Teaching Material" target="_blank" rel="noopener noreferrer" class="btn btn-sm btn-primary"><i class="bi-printer"> Report</i></a>
