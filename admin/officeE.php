...
<html lang="en">
  <head>
    ...
    <title>Inventory System - Office Equipments</title>
      ...
      <div class="row">
        <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
          ...
          <div class="position-sticky pt-3 sidebar-sticky">
            <ul class="nav flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link active ms-2" href="officeE.php">
                  <i class="bi-lamp"></i>
                  Office Equipments
                </a>
              </li>
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2"><i class="bi-lamp"></i> Office Equipments</h1>
            <input type="hidden" class="form-control w-25" id="searchprp" placeholder="Search Property #">
            <input type="hidden" name="" id="invtype" value="Office Equipment">
          ...
          <button class="btn btn-outline-primary btn-sm mt-2 mb-2 px-3" onclick="btn_add_lm()">Add Office Equipment</button>
          <a href="pdfReport/report.php?lm=Office Equipment" target="_blank" rel="noopener noreferrer" class="btn btn-sm btn-primary"><i class="bi-printer"> Report</i></a>
      ...
      <div class="modal-dialog">
        ...
        <form id="lerningM">
          <div class="modal-header">
            <h1 class="modal-title fs-5" id="staticBackdropLabel">Office Equipment</h1>
