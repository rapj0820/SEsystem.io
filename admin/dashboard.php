<?php
  ...
  $query1 = "SELECT * FROM learning_materials AS lm JOIN tbl_request AS tr ON lm.lm_id=tr.stat_id WHERE tr.stat = 'Done' AND lm.materialtype ='Learning Material'";
  $query2 = "SELECT * FROM learning_materials AS lm JOIN tbl_request AS tr ON lm.lm_id=tr.stat_id WHERE tr.stat = 'Done' AND lm.materialtype ='Textbook'";
  $query3 = "SELECT * FROM learning_materials AS lm JOIN tbl_request AS tr ON lm.lm_id=tr.stat_id WHERE tr.stat = 'Done' AND lm.materialtype ='Teaching Material'";
  $query4 = "SELECT * FROM learning_materials AS lm JOIN tbl_request AS tr ON lm.lm_id=tr.stat_id WHERE tr.stat = 'Done' AND lm.materialtype ='Instructional Material'";
  $query5 = "SELECT * FROM learning_materials AS lm JOIN tbl_request AS tr ON lm.lm_id=tr.stat_id WHERE tr.stat = 'Done' AND lm.materialtype ='IT Equipment'";
  $query6 = "SELECT * FROM learning_materials AS lm JOIN tbl_request AS tr ON lm.lm_id=tr.stat_id WHERE tr.stat = 'Done' AND lm.materialtype ='Office Equipment'";
  $query7 = "SELECT * FROM learning_materials AS lm JOIN tbl_request AS tr ON lm.lm_id=tr.stat_id WHERE tr.stat = 'Done' AND lm.materialtype ='Science Laboratory'";
  $query8 = "SELECT * FROM learning_materials AS lm JOIN tbl_request AS tr ON lm.lm_id=tr.stat_id WHERE tr.stat = 'Done' AND lm.materialtype ='Other Property'";
  ...
  <body>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
          <div class="row shadow-sm g-4">
            <div class="col-sm-8 bg-light">
            <h1 class="h5"><i class="bi-receipt"></i> Transaction History</h1>
              <table class="table table-hover">
                ...
                <tbody>
                  <?php 
                  $queryhistory = $conn -> query("SELECT * FROM tbl_transaction AS trans INNER JOIN tbl_user AS user ON trans.activity_person=user.idnum ORDER BY history_id DESC LIMIT 7");
              ...
              <center> <a class="nav-link text-primary mb-3" href="transaction.php"><i class="bi-chevron-double-down"></i> Show All </a> </center>
              </div>

            <div class="col-sm-4">
            <h3 class="h5"><i class="bi-card-list"></i> Pending Requests</h3>
              <table class="table">
                <thead>
                  <tr>
                    <th>Date</th>
                ...
                <?php 
                  $queryReq = "SELECT * FROM tbl_request AS req INNER JOIN learning_materials AS inv ON req.stat_id=inv.lm_id INNER JOIN tbl_user AS user ON req.user_request=user.idnum WHERE req.stat = 'Pending'";
                  $queryRequest = $conn -> query($queryReq);
                  if(mysqli_num_rows($queryRequest)>0){
                    while($historyRow = mysqli_fetch_assoc($queryRequest)){
                  ?>
                    <tr>
                      <td><?=$historyRow['stat_date']?></td>
                      <td><?=$historyRow['fullname']?></td>
                      <td><?=$historyRow['materialtype']?></td>
                    </tr>
                  <?php
                    }
                  }
              ...
              <center> <a class="nav-link text-primary mb-3" href="request.php"><i class="bi-chevron-double-down"></i> Show All </a> </center>
            </div>
          </div>
